	...
	<div class="base-autocomplite-wrapper" :class="{ 'invalid': error }">
		<label>
			...
			<div class="input-container">
				...
				<BaseIcon v-if="!multiple && selectedItems.length && selectedItems[0].icon" :name="selectedItems[0].icon" size="1.4em"></BaseIcon>
				<BaseIcon v-else-if="prependIcon" :name="prependIcon" size="16" fill="currentColor"></BaseIcon>
				<input
					type="text"
