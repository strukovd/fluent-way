<template>
	<div class="learn-page">
		...
		<section class="tags">
			<div class="tag" v-for="(tag, index) of [
				{ key: 'WORD', name: 'Слова' },
				{ key: 'PHRASE', name: 'Фразы' },
				{ key: 'PHRASAL_VERB', name: 'Фразальные глаголы' },
				{ key: 'IDIOM', name: 'Идиомы' },
				{ key: 'COLLOCATION', name: 'Коллокации' },
				{ key: 'EXPRESSION', name: 'Выражения' },
				{ key: 'PROVERB', name: 'Приказы' },
				{ key: 'SENTENCE', name: 'Предложения' },
			]" :key="tag.key" :class="{ 'selected': index === 4 }">
				<span v-if="tag?.icon" v-html="tag.icon" style="margin-right:.4em;"></span>
		...
		<section class="words-list">
			<Lexeme v-for="word of words" :key="word.name" :lexeme="word"/>
		</section>
	</div>
</template>
...
import Lexeme from '../common/Lexeme.vue';

export default defineComponent({
	name: 'LearnPage',
	components: { BaseIcon, BaseAutocomplite, LearningProgress, Lexeme },
	data() {
		return {
			tags: [
				{ key: ``, name: `Все` },
